...
function EmptySearch() {
    const EmptySearch = `<svg width="1062" height="870" viewBox="0 0 1062 870" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g id="No Results">
    <g id="circle">
    <path id="Stroke 1" d="M34.8164 399V408" stroke="#D2D8DF" stroke-width="2.921" stroke-linecap="round"/>
    <g id="Group 8">
    <path id="Stroke 2" d="M14.6016 403.875L21.9558 411.446" stroke="#D2D8DF" stroke-width="2.921" stroke-linecap="round"/>
    <path id="Stroke 4" d="M6 424.028H16.3989" stroke="#D2D8DF" stroke-width="2.921" stroke-linecap="round"/>
    <path id="Stroke 6" d="M13.7578 444.539L21.1121 436.969" stroke="#D2D8DF" stroke-width="2.921" stroke-linecap="round"/>
    </g>
    <path id="Stroke 9" d="M34.8164 447V438" stroke="#D2D8DF" stroke-width="2.921" stroke-linecap="round"/>
    <path id="Stroke 10" d="M49.8164 441L43.8164 435" stroke="#D2D8DF" stroke-width="2.921" stroke-linecap="round"/>
    <path id="Stroke 11" d="M61.8164 426H52.8164" stroke="#D2D8DF" stroke-width="2.921" stroke-linecap="round"/>
    <path id="Stroke 12" d="M55.8164 405L49.8164 411" stroke="#D2D8DF" stroke-width="2.921" stroke-linecap="round"/>
    ...
    <path id="Fill 28" fill-rule="evenodd" clip-rule="evenodd" d="M83.6309 581.117C87.4868 579.914 93.393 575.201 94.7607 570.129C96.001 574.61 101.199 579.914 105.891 580.317C100.611 582.184 95.563 587.74 94.7607 592.104C94.2157 587.656 87.2321 581.764 83.6309 581.117Z" fill="#EBECEE"/>
    ...
    <path id="Stroke 38" fill-rule="evenodd" clip-rule="evenodd" d="M338.341 99.0952C338.341 104.659 333.833 109.166 328.273 109.166C322.713 109.166 318.205 104.659 318.205 99.0952C318.205 93.5339 322.713 89.0248 328.273 89.0248C333.833 89.0248 338.341 93.5339 338.341 99.0952Z" stroke="#D2D8DF" stroke-width="2.921" stroke-linecap="round"/>
    ...
    <path id="Fill 29" fill-rule="evenodd" clip-rule="evenodd" d="M817.811 636.161L766.964 687L757.811 677.839L808.65 627L817.811 636.161Z" fill="#53B175"/>
...
`;
    ...
    const EmptySearchSvg = () => (
        <SvgXml xml={EmptySearch} height={250} width={250} />
    );
    return <EmptySearchSvg />;
}
